...
# pge is the territory
# lf is the total lifetime chosen
# yr is the year of battery operation -- it degrades
...
def tou(pge,lf,yr):
    ...
    dgrdrate = 1.28/lf
    maxcap = 6.4-dgrdrate*(yr-1) #battery capacity 6.4kWh Tesla powerwall weekly version
    cap = 0
